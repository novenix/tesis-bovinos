...
classes = ["cow", "cattle", "livestock", "person"]

print("🧪 TEST 5.2: PROBANDO CLASE NEGATIVA (PERSON)")
print("="*60)
...
for img_name in problem_images:
    ...
    if len(results[0].boxes) == 0:
        ...
        for box in results[0].boxes:
            ...
            status = "❌ FALSO POSITIVO" if cls_name != "person" else "✅ CORRECTO (Persona)"
            print(f"   {status}: {cls_name} (Conf: {conf:.2f})")