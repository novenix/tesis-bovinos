...
# nohup /opt/anaconda3/envs/tesis_vacas/bin/python -u /data/estudiantes/vacas/17.2.preparar_test_rigor_medium.py > logs/output_v17_test_rigor.log 2>&1 &

import os
# --- CONFIGURACIÓN DE GPU (CRATOS 3) ---
...
TEMP_FRAMES_DIR = BASE_PATH / "frames_temp/test_rigor_medium"
OUTPUT_DATASET_DIR = BASE_PATH / "dataset_v3_medium/test"
SAM3_PATH = BASE_PATH / "sam3"
BEST_MODEL_PATH = BASE_PATH / "runs/segment/tesis_bovinos_medium/train_v17_medium/weights/best.pt"
...
SIMPLIFY_TARGET = 250 # Para Medium
...
def main():
    print("🚀 [MEDIUM] Iniciando Preparación de Test de Rigor (Pipeline Espejo)...")
    ...
    yaml_path = BASE_PATH / "dataset_v3_medium/dataset_v3.yaml"
    ...
    print(f"✅ [MEDIUM] Test Rigor preparado en: {OUTPUT_DATASET_DIR}")
    
    # 5. Ejecutar Validación Final de Test
    print("📊 Iniciando Evaluación Final en Test Set...")
    model = YOLO(BEST_MODEL_PATH)
    model.val(data=str(yaml_path), split='test', imgsz=640, project="runs/segment/tesis_bovinos_medium/train_v17_medium", name="test_rigor_medium")
